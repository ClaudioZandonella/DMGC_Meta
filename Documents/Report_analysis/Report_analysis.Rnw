...
\centering
	\vspace*{2cm}
	{\huge \bf The effects of educational video-games\linebreak on students motivation to math:\linebreak A meta-analysis in K-12}\\
	\vspace{1cm}



  \if\printauthors1
  	{\Large Daniela Fadda~$^1$, Giuliano Vivanet~$^1$, Marta Pellegrini~$^2$,\\ \& Claudio Zandonelle Callegher~$^3$\par}
    \vspace{1cm}
    {\small
    $^1$ Dipartimento di Pedagogia,Psicologia, Filosofia - Università di Cagliari\\
    $^2$ Dipartimento di Formazione, Lingue, Intercultura, Letterature e Psicologia - Università degli Studi di Firenze\\
    $^3$ Department of Developmental Psychology and Socialisation, University of Padova, Padova, Italy\par}
  	\vspace{2cm}
