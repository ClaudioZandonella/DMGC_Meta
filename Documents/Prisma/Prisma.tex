...
Records identified through database searching (n = 2034)\\
...
\node (n3r) [mynode,right=of n3]    {Records excluded\\
                                    (n = 1756)};
\node (n4r) [mynode,right=of n4]    {Full-text articles excluded because not fulfill the inclusion criteria\\(n = 128)};
