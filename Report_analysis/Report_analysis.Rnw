...
<<Plot_dist_effects, fig.pos="t!", fig.align="center", fig.height=5, fig.width=6, fig.cap="Estimated effect size according to number of participants ($n_{studies}=19$; $n_{effects}=42$).", fig.scap="Estimated effect size according to number of participants">>=
