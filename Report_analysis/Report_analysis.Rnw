...
\begin{enumerate}
  \item{Install R version \Sexpr{paste0(c(version$major,".",version$minor), collapse="")} frmo CRAN and select it as the the R version used in RStudio (more info at this \href{https://support.rstudio.com/hc/en-us/articles/200486138-Changing-R-versions-for-RStudio-desktop}{link}).}
...
\begin{equation}
  cov(A, B) = \rho_{AB}*\sigma_A\sigma_B.
\end{equation}
